subroutine ed_get_doubles_n1(self)
  real(8),dimension(:) :: self !the four-dimensional array of values
...
subroutine ed_get_dust_n0(self)
  real(8) :: self !the value of :f:var:`dust`
  self = ed_Dust
...
subroutine ed_get_dund_n0(self)
  real(8) :: self !the value of :f:var:`dund`
  self = ed_Dund
...
subroutine ed_get_dse_n0(self)
  real(8) :: self !the value of :f:var:`dse`
  self = ed_Dse
...
subroutine ed_get_dph_n0(self)
  real(8) :: self !the value of :f:var:`dph`
  self = ed_Dph
