...
subroutine ed_get_g0imp_matsubara_main(Gmats,bath)
  ...
  call allocate_grids
  Gmats(:,:,:,:,:) = ed_get_g0imp_function(xi*wm,bath)
...
subroutine ed_get_g0imp_realaxis_main(Greal,bath)
  ...
  real(8),dimension(:)                                            :: bath
  call allocate_grids
  Greal(:,:,:,:,:) = ed_get_g0imp_function(dcmplx(wr,eps),bath,axis='real')
  call deallocate_grids
...
subroutine ed_get_f0imp_matsubara_main(Fmats,bath)
  ...
  real(8),dimension(:)                                            :: bath
  call allocate_grids
  Fmats(:,:,:,:,:) = ed_get_f0imp_function(xi*wm,bath)
  call deallocate_grids
...
subroutine ed_get_f0imp_realaxis_main(Freal,bath)
  ...
  real(8),dimension(:)                                            :: bath
  call allocate_grids
  Freal(:,:,:,:,:) = ed_get_f0imp_function(dcmplx(wr,eps),bath,axis='real')
  call deallocate_grids
