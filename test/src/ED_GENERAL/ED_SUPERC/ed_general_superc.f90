program ed_general_superc
  ...
  read(unit_,*) dens_(:)
  close(unit_)
  call assert(dens,dens_,"GENERAL_SUPERC dens(:)")
  ...
  read(unit_,*) docc_(:)
  close(unit_)
  call assert(docc,docc_,"GENERAL_SUPERC docc(:)")
  ...
  read(unit_,*) phisc_(:)
  close(unit_)
  call assert(phisc,phisc_,"GENERAL_SUPERC phisc(:)")
  ...
  read(unit_,*) energy_(:)
  close(unit_)
  call assert(energy,energy_,"GENERAL_SUPERC energy(:)")
  ...
  read(unit_,*) imp_(:)
  close(unit_)
  call assert(imp,imp_,"GENERAL_SUPERC imp(:)")
  ...
  close(unit_)
  call assert(Smats11,Smats11_,"GENERAL_SUPERC Smats11(:)",tol=1.0d-8)
  ...
  close(unit_)
  call assert(ASmats11,ASmats11_,"GENERAL_SUPERC Smats11(:)",tol=1.0d-8)
  ...
  close(unit_)
  call assert(ASmats12,ASmats12_,"GENERAL_SUPERC Smats12(:)",tol=1.0d-8)
