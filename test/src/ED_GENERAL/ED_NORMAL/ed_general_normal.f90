program ed_general_normal
  ...
  do i=1,Nbath
     lambdasym_vector(:,1) = -1.0 + 2.0*dble(i-1)/dble(Nbath-1)
  end do
  !
  ! E0
  ...
  read(unit_,*) dens_(:)
  close(unit_)
  call assert(dens,dens_,"GENERAL_NORMAL dens(:)")
  ...
  read(unit_,*) docc_(:)
  close(unit_)
  call assert(docc,docc_,"GENERAL_NORMAL docc(:)")
  ...
  read(unit_,*) exciton_(:)
  close(unit_)
  call assert(exciton,exciton_,"GENERAL_NORMAL exciton(:)")
  ...
  read(unit_,*) energy_(:)
  close(unit_)
  call assert(energy,energy_,"GENERAL_NORMAL energy(:)")
  ...
  read(unit_,*) imp_(:)
  close(unit_)
  call assert(imp,imp_,"GENERAL_NORMAL imp(:)")
  ...
  close(unit_)
  call assert(Smats11,Smats11_,"GENERAL_NORMAL Smats11(:)",tol=1.0d-8)
  ...
  close(unit_)
  call assert(Smats12,Smats12_,"GENERAL_NORMAL Smats12(:)",tol=1.0d-8)
